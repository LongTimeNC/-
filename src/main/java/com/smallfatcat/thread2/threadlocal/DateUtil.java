...
public final class DateUtil {
    ...
    /** * 格式化完整日期 * * @param date * @return yyyy-MM-dd HH:mm:ss格式的字符串 */
    public static final String formatDate(Date date) {
        return DATE_FORMAT.get().format(date);
    }

    /** * 格式化年月日 * * @param date * @return yyyy-MM-dd格式的字符串 */
    public static final String formatYMD(Date date) {
        return YMD.get().format(date);
    }

    /** * 获取指定日期0点的字符串 * * @param date * @return 返回示例:2017-12-23 00:00:00 */
    ...
    /** * 获取指定日期末点的字符串 * * @param date * @return 返回示例:2017-12-23 23:59:59 */
    ...
    /** * 获取指定日期的0点的毫秒数 * * @param date * @return */
    ...
    /** * 获取指定日期的末点的毫秒数 * * @param date * @return */
